...
public class Kernel extends Thread
{
  ...
  public void init( String commands , String config )  
  {
    ...
    {
      DataInputStream in = new DataInputStream(new FileInputStream(f));
      System.out.println("DataInputStream in = "+in);//////===========================================//////////
      int contador=0;  //////===========================================//////////
      while ((line = in.readLine()) != null) 
      {
        ...
        if (line.startsWith("READ") || line.startsWith("WRITE")) 
        {
          ...
          StringTokenizer st = new StringTokenizer(line);
          System.out.println("StringTokenizer st = "+st.toString()); //////===========================================//////////
          tmp = st.nextToken();
          ...
          if (tmp.startsWith("random")) 
          {
            ...
            //System.out.println("instructVector = "+instructVector.toString()); //////===========================================//////////
            System.out.println("\tcommand:"+command+" addr:"+addr+"\ninstructVector = "+instructVector.toString()); //////===========================================//////////
          } 
          else 
          { 
  ...
  public void step()
  {
    ...
    System.out.println("addressradix: "+addressradix);//////===========================================//////////
