...
public class ControlPanel extends Frame 
{
  ...
  Label resultadoValLabel = new Label("Val Resultado" , Label.LEFT) ;//////===========================================//////////
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    b0.setBackground( Color.cyan ); //tomo agua-marina
    add ( b0 );
    ...
    addressValueLabel.setText("Hola :v Soy direccion");
    ...
    resultadoValLabel.reshape( 395,300,230,15 ); //////===========================================//////////
    add( resultadoValLabel); //////===========================================//////////
    ...
    Label resultadoTexLabel = new Label("Resultado:" , Label.LEFT) ;//////===========================================//////////
    resultadoTexLabel.reshape(285,300,110,15); //////===========================================//////////
    add(resultadoTexLabel);//////===========================================//////////
  ...
  public void paintPage( Page page ) 
  {
    ...
    //////===========================================//////////
    resultadoValLabel.setText(page.resultado); //////===========================================//////////
  }
